...
class MyDetector(caffe.Net):
    ...
    def detect_windows(self, images_windows):
        ...
        print "possible blobs:", self.blobs.keys()
        print [(k, v.data.shape) for k, v in self.blobs.items()]
        print "selected out keys:", out.keys()
        #fc7 = out['fc7']
        fc7_output = out['fc7'].squeeze(axis=(2,3))
